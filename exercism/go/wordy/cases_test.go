...
var tests = []wordyTest{
	...
	{
		description: "reject plus by",
		question:    "What is 1 plus by 2?",
		expectError: true,
		expected:    0,
	},
	{
		description: "reject minus by",
		question:    "What is 1 minus by 2?",
		expectError: true,
		expected:    0,
	},
	{
		description: "reject multiplied without by",
		question:    "What is 1 multiplied 2?",
		expectError: true,
		expected:    0,
	},
	{
		description: "reject divided without by",
		question:    "What is 1 divided 2?",
		expectError: true,
		expected:    0,
	},
	{
		description: "decreased and increased by",
		question:    "What is 1 decreased by 2 increased by 2?",
		expectError: false,
		expected:    1,
	},
	{
		description: "twice decreased by",
		question:    "What is 1 decreased by 2 decreased by 3?",
		expectError: false,
		expected:    -4,
	},
}
